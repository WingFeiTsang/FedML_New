...
nohup ./run_fedavg_performance_grpc.sh lenet mnist "./../data/MNIST" hetero 0.5 2 2 10 adam GRPC 0.1 0.01 10 2 1 2 2 grpc_ipconfig.csv 0 > ./runret 2>&1 &
exit
eeooff
...
sh ./run_fedavg_performance_grpc.sh lenet mnist "./../data/MNIST" hetero 0.5 2 2 10 adam GRPC 0.1 0.01 10 2 1 2 2 grpc_ipconfig.csv 0
